...
Gui, Add, ComboBox, x102 y9 w100 h100 vStartGPS Choose1, 자동사냥|메인퀘|크자카|낚시|토벌
Gui, Add, Text, x212 y9 w80 h20 , *프로세스명
Gui, Add, Edit, x292 y9 w100 h20 vWinNmEdit
Gui, Add, Text, x12 y39 w90 h100 , 장비제물
Gui, Add, ComboBox, x102 y39 w100 h100 vblackPixieEat Choose5, 회색|하얀색|초록색|파란색|보라색|노란색
Gui, Add, Text, x12 y69 w90 h20 , 펫 먹이
Gui, Add, ComboBox, x102 y69 w100 h60 vpetEatSel Choose2, 기본|영양식
Gui, Add, Text, x212 y39 w80 h20 , 수정합성
Gui, Add, ComboBox, x292 y39 w100 h60 vcrystalSel Choose2, 초록색|파란색
